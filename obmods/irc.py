...
from olib import Default, Object, format, last, save, update
...
class IRC(Handler):
    ...
    def NOTICE(self, event):
        if event.txt.startswith("VERSION"):
            txt = "\001VERSION %s %s - %s\001" % ("OB", __version__, "write your own commands.")
...
class DCC(Handler):
    ...
    def connect(self, event):
        ...
        try:
            ...
            return
        s.send(bytes('Welcome to OB %s, write your own commands.\n' % event.nick, "utf-8"))
        s.setblocking(1)
